...
<%@include file="common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>用户照片：</strong><span><img width="300px" height="300px" alt="用户照片" src="${pageContext.request.contextPath }/statics/uploadfiles/${user.idpicpath}"/></span></p>
            <p><strong>工作照片：</strong><span><img width="300px" height="300px" alt="用户照片" src="${pageContext.request.contextPath }/statics/uploadfiles/${user.workpicpath}"/></span></p>
