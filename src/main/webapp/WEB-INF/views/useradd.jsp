...
<div class="right">
        ...
        <%--
            ...
            <form:form enctype="multipart/form-data"  modelAttribute="user" id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/user/goadduser.html">
				<input type="hidden" name="method" value="add">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div>
                    <label for="userCode">用户编码：</label>
                    <form:input id="userCode" path="usercode"/> 
					<!-- 放置提示信息 -->
					<font color="red"></font>
                </div>
                <div>
                ...
                <div>
                    <label for="userPassword">用户密码：</label>
                    <form:password id="userPassword" path="userpassword"/> 
					<font color="red"></font>
                </div>
                <div>
                    <label for="ruserPassword">确认密码：</label>
                ...
                <div>
                    <label >用户性别：</label>
					 ...
					 <form:select id="gender" path="gender">
					 	<form:option value="2">男</form:option>
					 	<form:option value="1">女</form:option>
					 </form:select>
                </div>
                <div>
                    <label for="birthday">出生日期：</label>
					<form:input cssClass="Wdate" path="birthday" readonly="readonly" onclick="WdatePicker();" />
